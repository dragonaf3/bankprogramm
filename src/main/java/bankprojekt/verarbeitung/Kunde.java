...
public class Kunde implements Comparable<Kunde>, Serializable {
    ...
    private transient StringProperty adresseProperty = new SimpleStringProperty();
    ...
    /**
     * Gibt die Adresse als StringProperty zurück
     *
    ...
    /**
     * setzt die Adresse auf den angegebenen Wert und die StringProperty
     *
